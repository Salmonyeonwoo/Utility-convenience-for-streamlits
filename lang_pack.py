...
LANG: Dict[str, Dict[str, str]] = {
    "ko": {
        ...
        "qa_points_unit": "점",
        "qa_cases_unit": "건",
        "qa_pass_target_met": "합격 기준(75점) 달성",
        "qa_pass_target_unmet": "합격 기준(75점) 미달",
        "qa_items_compliant": "4개 항목 중 {n}개 준수",
        "qa_clean_status": "정상 (Clean)",
        "qa_deduction_status": "{n}건 감점 발생",
        "qa_dim_header": "📈 다차원 품질 지표",
        "qa_empathy_title": "공감도 및 친절도 (Empathy & Courtesy)",
        "qa_solution_title": "해결책 및 규정 정확도 (Solution Accuracy)",
        "qa_compliance_title": "절차 준수 및 컴플라이언스 (Compliance)",
        "qa_chk_header": "📋 필수 고지 4단계 체크리스트",
        "qa_prohibited_header": "🚨 금지어 및 리스크 발언 탐지 결과",
        "qa_clean_msg": "✅ **금지어 및 리스크 발언 0건 (Clean)**\n단정적 거절이나 고객 귀책 전가 없이 규정을 완벽히 준수했습니다.",
        "qa_coaching_header": "💡 상담원 맞춤형 AI 코칭 피드백",
        "qa_good_points": "🌟 우수 사항 (Good Points):",
        "qa_improvements": "⚠️ 개선 권장 사항 (Improvements):",
        "qa_supervisor_summary": "👔 수퍼바이저 종합 총평:",
        "qa_home_center_title": "🏢 센터 전체 QA 품질 & 컴플라이언스 총괄 현황",
        "qa_home_center_desc": "AI 기반 실시간 전수 감사를 통해 도출된 상담 품질 지표, 규정 준수율 및 금지어 적발 통계입니다.",
        "qa_home_avg_score": "🏆 센터 평균 QA 점수",
        "qa_home_avg_score_delta": "+4.2점 (A등급)",
        "qa_home_compliance_rate": "📋 필수 고지 준수율",
        "qa_home_compliance_rate_delta": "+6.8% (최우수)",
        "qa_home_risk_rate": "🚨 금지어/리스크 적발률",
        "qa_home_risk_rate_delta": "-1.4% (안전 수준)",
        "qa_home_coaching_rate": "💡 AI 코칭 이행률",
        "qa_home_coaching_rate_delta": "+8.5% 개선",
        "qa_home_sim_title": "🔍 실시간 상담 케이스 자동 감사 시뮬레이터 (Case Audit Viewer)",
        "qa_home_select_case": "감사 대상 상담 케이스 선택:",
        "qa_home_case_good": "모범 상담 케이스 (eSIM 장애 긴급 해결 & 규정 안내)",
        "qa_home_case_bad": "컴플라이언스 위반 케이스 (단정적 거절 & 임의 구두 확약)",
        "qa_home_audit_result_header": "종합 감사 결과: {grade} 등급 ({desc})",
        "qa_home_audit_score_label": "종합 QA 점수",
        "qa_home_sub_metrics": "세부 품질 지표",
        "qa_home_checklist_sub": "필수 고지 체크리스트",
        "qa_home_prohibited_sub": "금지어 및 리스크 발언",
        "qa_home_coaching_sub": "AI 맞춤형 코칭 피드백",
        ...
        "content_type_summary": "핵심 요약 노트",
        "content_type_quiz": "객관식 퀴즈 10문항",
        "content_type_example": "실습 예제 아이디어",
        "content_type_email": "이메일",
        "content_type_notice": "안내문",
        "content_type_proposal": "제안서",
        "content_type_template": "응답 템플릿",
        ...
        "today_cs_cases": "오늘 CS 인입 케이스",
        "assigned_customers": "담당 고객 수",
        "consultation_goal_achievements": "상담 목표 달성 개수",
        "target_label": "목표",
        "average_response_time": "평균 응답 시간",
        "customer_satisfaction": "고객 만족도",
        "key_features": "주요 기능",
        "company_info_faq": "회사 정보 및 FAQ",
        "lstm_score_analysis": "LSTM 점수 분석",
        "custom_content_generation": "맞춤형 콘텐츠 생성",
        "rag_chatbot": "RAG 챗봇",
        "search_query_input": "검색어 입력:",
        "search_placeholder": "회사명, 업종, 서비스 등으로 검색...",
        "search_button": "🔍 검색",
        "search_results": "검색 결과: {count}개",
        "industry_label": "업종:",
        "description_label": "설명:",
        "question_label": "질문:",
        "question_placeholder": "이 회사에 대해 질문하세요...",
        "ask_button": "질문하기",
        "close_button": "닫기",
        "customer_label": "고객:",
        "lstm_sentiment_score": "LSTM 감정 점수",
        "intent_prediction": "의도 예측",
        "positive": "긍정적",
        "package_inquiry": "패키지 문의",
        "confidence": "신뢰도",
        "select_customer_for_lstm": "고객을 선택하면 LSTM 분석 결과를 확인할 수 있습니다.",
        "content_type_label": "콘텐츠 유형:",
        "topic_label": "주제:",
        "topic_placeholder": "학습할 주제를 입력하세요...",
        "generate_button": "생성",
        "content_generation_error": "콘텐츠 생성 중 오류",
        "enter_topic_and_api_key": "주제를 입력하고 API 키를 설정해주세요.",
        "quiz_progress": "📝 퀴즈 진행",
        "quiz_complete": "퀴즈 완료!",
        "score_label": "점수:",
        "question_results": "문제 결과",
        "question_number": "문항 {num}",
        "my_answer": "내 답안:",
        "correct_answer": "정답:",
        "retake_quiz": "다시 풀기",
        "answer_choice": "답안 선택",
        ...
        "incorrect": "틀렸습니다.",
        "explanation": "해설",
        "no_explanation": "해설이 제공되지 않았습니다.",
        "no_search_results": "검색 결과가 없습니다.",
        "enter_search_query": "검색어를 입력해주세요.",
        "search_error": "검색 중 오류가 발생했습니다: {error}",
        "company_info_generated": "{company} 회사 정보를 생성했습니다!",
        "generating_company_info": "{company} 회사 정보 생성 중...",
        "no_api_key_for_company_info": "검색 결과가 없습니다. API 키를 설정하면 LLM으로 회사 정보를 생성할 수 있습니다.",
        "company_info_generation_error": "회사 정보 생성 중 오류: {error}",
        "popular_products": "인기 제품:",
        "faq_label": "FAQ:",
        "cannot_load_customer_info": "고객 정보를 불러올 수 없습니다.",
        "no_answer": "미응답",
        "please_select_option": "선택지를 선택해 주세요.",
        ...
        "similarity_percent": "유사도 (%)",
        "score_label_short": "점수",
        "satisfaction_score_label": "만족도",
        "customer_satisfaction_score_label": "고객 만족도 점수",
        "customer_profile_analysis": "고객 프로필 분석",
        "similar_case_recommendation": "유사 케이스 추천",
        "similar_cases_detail_info": "개 유사 케이스 상세 정보",
        "case_similarity_format": "케이스 {num} (유사도: {similarity}%)",
        "inquiry_content_label": "문의 내용:",
        "sentiment_score_label_short": "감정 점수:",
        "satisfaction_score_label_short": "만족도 점수:",
        "key_response_label": "핵심 응답:",
        "count_unit": "개",
    ...
    "en": {
        ...
        "qa_points_unit": "pts",
        "qa_cases_unit": "cases",
        "qa_pass_target_met": "Passing standard (75 pts) achieved",
        "qa_pass_target_unmet": "Below passing standard (75 pts)",
        "qa_items_compliant": "{n} of 4 items compliant",
        "qa_clean_status": "Clean (0 violations)",
        "qa_deduction_status": "{n} penalties detected",
        "qa_dim_header": "📈 Multi-dimensional Quality Metrics",
        "qa_empathy_title": "Empathy & Courtesy",
        "qa_solution_title": "Solution & Policy Accuracy",
        "qa_compliance_title": "Procedural Compliance",
        "qa_chk_header": "📋 4-Step Mandatory Disclosures Checklist",
        "qa_prohibited_header": "🚨 Prohibited & Risk Words Detection",
        "qa_clean_msg": "✅ **0 Prohibited / Risk Words (Clean)**\nFully complied with customer service guidelines without abrupt refusals or blaming.",
        "qa_coaching_header": "💡 Agent Tailored AI Coaching Feedback",
        "qa_good_points": "🌟 Good Points:",
        "qa_improvements": "⚠️ Areas for Improvement:",
        "qa_supervisor_summary": "👔 Supervisor Executive Summary:",
        "qa_home_center_title": "🏢 Center-Wide QA Quality & Compliance Overview",
        "qa_home_center_desc": "Contact center quality metrics, compliance rate, and prohibited word audit statistics derived from real-time AI full-inspection.",
        "qa_home_avg_score": "🏆 Center Avg QA Score",
        "qa_home_avg_score_delta": "+4.2 pts (Grade A)",
        "qa_home_compliance_rate": "📋 Mandatory Disclosure Rate",
        "qa_home_compliance_rate_delta": "+6.8% (Excellent)",
        "qa_home_risk_rate": "🚨 Risk Words Detected Rate",
        "qa_home_risk_rate_delta": "-1.4% (Safe Level)",
        "qa_home_coaching_rate": "💡 Coaching Adoption Rate",
        "qa_home_coaching_rate_delta": "+8.5% Improved",
        "qa_home_sim_title": "🔍 Real-time Case Audit Simulator (Case Audit Viewer)",
        "qa_home_select_case": "Select Audit Target Case:",
        "qa_home_case_good": "Exemplary Case (eSIM Troubleshooting & Policy Disclosure)",
        "qa_home_case_bad": "Compliance Violation Case (Abrupt Refusal & Oral Promise)",
        "qa_home_audit_result_header": "Overall Audit Result: Grade {grade} ({desc})",
        "qa_home_audit_score_label": "Overall QA Score",
        "qa_home_sub_metrics": "Detailed Quality Metrics",
        "qa_home_checklist_sub": "Mandatory Disclosure Checklist",
        "qa_home_prohibited_sub": "Prohibited & Risk Words",
        "qa_home_coaching_sub": "AI Tailored Coaching Feedback",
        ...
        "content_type_summary": "Key Summary Note",
        "content_type_quiz": "10 MCQ Questions",
        "content_type_example": "Practical Example Idea",
        "content_type_email": "Email",
        "content_type_notice": "Notice",
        "content_type_proposal": "Proposal",
        "content_type_template": "Response Template",
        ...
        "similar_case_recommendation": "Similar Case Recommendation",
        "similar_cases_detail_info": " similar case(s) details",
        "case_similarity_format": "Case {num} (Similarity: {similarity}%)",
        "inquiry_content_label": "Inquiry Content:",
        "sentiment_score_label_short": "Sentiment Score:",
        "satisfaction_score_label_short": "Satisfaction Score:",
        "key_response_label": "Key Response:",
        "count_unit": "",
        "dashboard_title": "📊 Dashboard",
        "home_page_module_error": "Unable to load home page module.",
        "today_cs_cases": "Today's CS Inbound Cases",
        "assigned_customers": "Number of Assigned Customers",
        "consultation_goal_achievements": "Number of Consultation Goals Achieved",
        "target_label": "Target",
        "average_response_time": "Average Response Time",
        "customer_satisfaction": "Customer Satisfaction",
        "key_features": "Key Features",
        "company_info_faq": "Company Info & FAQ",
        "lstm_score_analysis": "LSTM Score Analysis",
        "custom_content_generation": "Custom Content Generation",
        "rag_chatbot": "RAG Chatbot",
        "search_query_input": "Search Query Input:",
        "search_placeholder": "Search by company name, industry, service, etc...",
        "search_button": "🔍 Search",
        "search_results": "Search Results: {count}",
        "industry_label": "Industry:",
        "description_label": "Description:",
        "question_label": "Question:",
        "question_placeholder": "Ask a question about this company...",
        "ask_button": "Ask",
        "close_button": "Close",
        "customer_label": "Customer:",
        "lstm_sentiment_score": "LSTM Sentiment Score",
        "intent_prediction": "Intent Prediction",
        "positive": "Positive",
        "package_inquiry": "Package Inquiry",
        "confidence": "Confidence",
        "select_customer_for_lstm": "Select a customer to view LSTM analysis results.",
        "content_type_label": "Content Type:",
        "topic_label": "Topic:",
        "topic_placeholder": "Enter the topic to learn...",
        "generate_button": "Generate",
        "content_generation_error": "Error generating content",
        "enter_topic_and_api_key": "Please enter a topic and set up an API key.",
        ...
        "search_error": "Error occurred during search: {error}",
        "company_info_generated": "✅ {company} company information has been generated!",
        "generating_company_info": "Generating {company} company information...",
        "no_api_key_for_company_info": "No search results found. You can generate company information with LLM by setting up an API key.",
        "company_info_generation_error": "Error generating company information: {error}",
        "popular_products": "Popular Products:",
        "faq_label": "FAQ:",
        "cannot_load_customer_info": "Unable to load customer information.",
        "no_answer": "No Answer",
    ...
    "ja": {
        ...
        "qa_points_unit": "点",
        "qa_cases_unit": "件",
        "qa_pass_target_met": "合格基準（75点）達成",
        "qa_pass_target_unmet": "合格基準（75点）未達",
        "qa_items_compliant": "4項目中{n}項目遵守",
        "qa_clean_status": "正常 (Clean)",
        "qa_deduction_status": "{n}件の減点発生",
        "qa_dim_header": "📈 多次元品質指標",
        "qa_empathy_title": "共感度＆親切度 (Empathy & Courtesy)",
        "qa_solution_title": "解決策＆規定正確度 (Solution Accuracy)",
        "qa_compliance_title": "手続き遵守＆コンプライアンス (Compliance)",
        "qa_chk_header": "📋 必須告知4段階チェックリスト",
        "qa_prohibited_header": "🚨 禁止用語＆リスク発言検知結果",
        "qa_clean_msg": "✅ **禁止用語＆リスク発言0件 (Clean)**\n断定的な拒絶や顧客への責任転嫁なく、規定を完全に遵守しました。",
        "qa_coaching_header": "💡 エージェント向けAIコーチングフィードバック",
        "qa_good_points": "🌟 優秀な点 (Good Points):",
        "qa_improvements": "⚠️ 改善推奨事項 (Improvements):",
        "qa_supervisor_summary": "👔 スーパーバイザー総合講評:",
        "qa_home_center_title": "🏢 センター全体のQA品質＆コンプライアンス統括現況",
        "qa_home_center_desc": "AIベースのリアルタイム全件監査を通じて算出された応対品質指標、規定遵守率、禁止用語検知統計です。",
        "qa_home_avg_score": "🏆 センター平均QAスコア",
        "qa_home_avg_score_delta": "+4.2点（A等級）",
        "qa_home_compliance_rate": "📋 必須告知遵守率",
        "qa_home_compliance_rate_delta": "+6.8%（最優秀）",
        "qa_home_risk_rate": "🚨 リスク用語検知率",
        "qa_home_risk_rate_delta": "-1.4%（安全水準）",
        "qa_home_coaching_rate": "💡 AIコーチング履行率",
        "qa_home_coaching_rate_delta": "+8.5% 改善",
        "qa_home_sim_title": "🔍 リアルタイム相談ケース自動監査シミュレーター (Case Audit Viewer)",
        "qa_home_select_case": "監査対象ケースの選択:",
        "qa_home_case_good": "模範相談ケース (eSIM障害の緊急解決＆規定案内)",
        "qa_home_case_bad": "コンプライアンス違反ケース (断定的拒絶＆口頭確約)",
        "qa_home_audit_result_header": "総合監査結果: {grade}等級 ({desc})",
        "qa_home_audit_score_label": "総合QAスコア",
        "qa_home_sub_metrics": "詳細品質指標",
        "qa_home_checklist_sub": "必須告知チェックリスト",
        "qa_home_prohibited_sub": "禁止用語＆リスク発言",
        "qa_home_coaching_sub": "AI個別コーチングフィードバック",
        ...
        "today_cs_cases": "本日のCS受付ケース",
        "assigned_customers": "担当顧客数",
        "consultation_goal_achievements": "相談目標達成数",
        "target_label": "目標",
        "average_response_time": "平均応答時間",
        "customer_satisfaction": "顧客満足度",
        "key_features": "主要機能",
        "company_info_faq": "会社情報およびFAQ",
        "lstm_score_analysis": "LSTMスコア分析",
        "custom_content_generation": "カスタムコンテンツ生成",
        "rag_chatbot": "RAGチャットボット",
        "search_query_input": "検索クエリ入力:",
        "search_placeholder": "会社名、業種、サービスなどで検索...",
        "search_button": "🔍 検索",
        "search_results": "検索結果: {count}件",
        "industry_label": "業種:",
        "description_label": "説明:",
        "question_label": "質問:",
        "question_placeholder": "この会社について質問してください...",
        "ask_button": "質問する",
        "close_button": "閉じる",
        "customer_label": "顧客:",
        "lstm_sentiment_score": "LSTM感情スコア",
        "intent_prediction": "意図予測",
        "positive": "ポジティブ",
        "package_inquiry": "パッケージ問い合わせ",
        "confidence": "信頼度",
        "select_customer_for_lstm": "顧客を選択するとLSTM分析結果を確認できます。",
        "content_type_label": "コンテンツタイプ:",
        "topic_label": "トピック:",
        "topic_placeholder": "学習するトピックを入力してください...",
        "generate_button": "生成",
        "content_generation_error": "コンテンツ生成中にエラーが発生しました",
        "enter_topic_and_api_key": "トピックを入力し、APIキーを設定してください。",
        "quiz_progress": "📝 クイズ進行",
        "quiz_complete": "クイズ完了！",
        "score_label": "スコア:",
        "question_results": "問題結果",
        "question_number": "問題{num}",
        "my_answer": "私の回答:",
        "correct_answer": "正解:",
        "retake_quiz": "再挑戦",
        "answer_choice": "回答選択",
        ...
        "incorrect": "不正解です。",
        "explanation": "解説",
        "no_explanation": "解説が提供されていません。",
        "no_search_results": "検索結果が見つかりませんでした。",
        "enter_search_query": "検索クエリを入力してください。",
        "search_error": "検索中にエラーが発生しました: {error}",
        "company_info_generated": "✅ {company}の会社情報が生成されました！",
        "generating_company_info": "{company}の会社情報を生成中...",
        "no_api_key_for_company_info": "検索結果が見つかりませんでした。APIキーを設定すると、LLMで会社情報を生成できます。",
        "company_info_generation_error": "会社情報生成中にエラーが発生しました: {error}",
        "popular_products": "人気製品:",
        "faq_label": "FAQ:",
        "cannot_load_customer_info": "顧客情報を読み込めません。",
        "no_answer": "未回答",
        "please_select_option": "選択肢を選択してください。",
        "today_files_info": "今日",
        ...
        "emotion_neutral": "中立",
        "similarity_chart_title": "ケース類似度",
        "similarity_percent": "類似度 (%)",
        "score_label_short": "スコア",
        "customer_profile_analysis": "顧客プロフィール分析",
        "similar_case_recommendation": "類似ケース推奨",
        "similar_cases_detail_info": "件の類似ケース詳細情報",
        "case_similarity_format": "ケース{num} (類似度: {similarity}%)",
        "inquiry_content_label": "問い合わせ内容:",
        "sentiment_score_label_short": "感情スコア:",
        "satisfaction_score_label_short": "満足度スコア:",
        "key_response_label": "核心応答:",
        "count_unit": "件",
